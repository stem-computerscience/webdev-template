# Level 1: Social Sleuth

**Lesson:** [Lesson 4 — Digital Footprint](../README.md)
**Type:** Exploration
**Source:** https://studio.code.org/courses/ai-discoveries-2026/units/3/lessons/4/levels/1
...
**instantframe**
- instantframe: johnsnow
- instantframe: @photolizzie
- instantframe: @desertrider
...
*Tip:* Students are asked to choose two users from the available profiles, but if you are short on time, you can ask students to complete just one of the footprints.
